...
Here is a list of KPI of the documents, answered from 7 questions :
{context_str}

Define document type as a word that best describe the document type.
A type can be for exemple "Encyclopedia", "Report", "Email", "Forum post", "Scientific paper", etc.
